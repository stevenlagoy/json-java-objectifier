...
public class JSONValidator {
    ...
    /*
     * JSON BNF Grammar <json> ::= <value> <value> ::= <string> | <number> | <object> | <array> | true | false | null
     *
     ...
     *
     * <string> ::= " <characters> " <characters> ::= <character> | <character> <characters> <character> ::= # any
     * unicode character except " or \ or control characters # | <escape>
     *
     * <escape> ::= \ (" | \ | / | b | f | n | r | t | u <hex><hex><hex><hex>)
     *
     * <number> ::= <int> <frac>? <exp>? <int> ::= -? <digits> <frac> ::= . <digits> <exp> ::= (e | E) (+ | -)? <digits>
     * <digits> ::= <digit> | <digit> <digits> <digit> ::= # digit from 0 to 9 # <hex> ::= <digit> | [a-f] | [A-F]
     */
