...
public class StringOperations {
     ...
     *
     * <p>
     * This method scans the input line from the beginning up to (but not including) the specified position. It toggles
     * the {@code inString} flag each time it encounters a non-escaped double quote character. This helps determine
     * whether the character at the given position falls within a string.
     * </p>
     *
     * @param line
     ...
     *
     * <p>
     * This method traverses the line up to (but not including) the given position, tracking array nesting depth. It
     * increments depth when encountering a non-escaped '[' character outside of a string, and decrements it for ']'. If
     * the resulting depth is greater than 0 at the given position, the position is considered to be inside an array.
     * </p>
     *
     * @param line
     *            The input string to analyze.
    ...
    /**
     * Replaces the last occurrence of a specified regular expression with a replacement string in the input text. This
     * method uses the {@link #replaceFirst(String, String, String)} method by reversing the string and performing the
     * replacement on the first occurrence in the reversed string.
     *
     * @param text
    ...
    /**
     * Replaces the first occurrence of a specified regular expression with a replacement string in the input text. This
     * method reverses the input string, performs the replacement on the first occurrence of the regex in the reversed
     * string, and then reverses the resulting string again to produce the final output.
     *
     * @param text
     *            The input string in which the replacement will be made.
     * @param regex
